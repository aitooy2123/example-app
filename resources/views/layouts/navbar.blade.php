...
<nav class="main-header navbar navbar-expand  navbar-white navbar-light">
  ...
  <ul class="navbar-nav">
    ...
    <li class="nav-item dropdown">
      <a id="dropdownSubMenu1" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="nav-link dropdown-toggle">Tools</a>
      <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow" style="left: 0px; right: inherit;">
        <li class="nav-item d-none d-sm-inline-block">
          <a href="{{ url('clear-cache') }}" class="nav-link"><i class="fas fa-tools"></i> ClearCache</a>
        </li>
        <li class="nav-item d-none d-sm-inline-block">
          <a href="{{ route('truncate') }}" class="nav-link"><i class="fas fa-tools"></i> Truncate</a>
        </li>
      </ul>
    </li>
    <!-- End Level two -->
  ...
  <ul class="navbar-nav ml-auto">
    ...
    <li class="nav-item dropdown user-menu">
      <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">
        <img @if(empty(Auth::user()->avatar)) src="{{ asset('dist/img/avatar4.png') }}"
